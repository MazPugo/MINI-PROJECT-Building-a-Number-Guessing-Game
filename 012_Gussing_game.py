...
while True: 
    ...
    if LOWER_BOUND <= user_guess <= UPPER_BOUND:
        ...
        print(f"Your guess is outside the range, try a guess between {LOWER_BOUND} and {UPPER_BOUND}")
    if  remaining_guesses ==0:
        print(f"Sorry you are out of guesses, The number you where after was {CORRECT_NUMBER}")
        break
